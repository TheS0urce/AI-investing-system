...
def summarize_preflight(
    *,
    ...
    return {
        ...
        "seconds_until_next_open": session_plan.get("seconds_until_next_open"),
        "seconds_until_next_close": session_plan.get("seconds_until_next_close"),
        "time_until_next_open": session_plan.get("time_until_next_open"),
        "time_until_next_close": session_plan.get("time_until_next_close"),
